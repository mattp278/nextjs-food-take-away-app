/*
  ...
  - The values [deserts] on the enum `FoodCategory` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "FoodCategory_new" AS ENUM ('starters', 'mains', 'sides', 'drinks');
